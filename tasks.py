...
def staging(c):
    ...
    c.config.namespace = "preen_test-staging"


@invoke.task
def production(c):
    c.config.env = "production"
    c.config.namespace = "preen_test-production"
...
ns.configure(
    {
        "app": "preen_test_app",
        "aws": {"region": "<<FILL_IN>>", "profile_name": "preen_test"},
        "cluster": "preen_test-stack-cluster",
        "container_name": "app",
