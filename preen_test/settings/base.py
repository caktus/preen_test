"""
Django settings for preen_test project.
...
WSGI_APPLICATION = "preen_test.wsgi.application"
...
ADMINS = os.getenv(
    ...
    [
        (
            "caktus-preen_test-team",
            "preen_test-team@caktusgroup.com",
        )
    ],
)

DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "no-reply@preen_test.caktus-built.com")
