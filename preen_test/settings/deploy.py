...
from preen_test.settings.base import *  # noqa: F403
...
EMAIL_SUBJECT_PREFIX = "[preen_test %s] " % ENVIRONMENT.title()
...
### ADMINS and MANAGERS
ADMINS = (("Preen Test Dev Team", "preen_test-team@caktusgroup.com"),)
