FROM node:14.17-alpine as static_files
WORKDIR /code
...
COPY --from=static_files /code/preen_test/static /code/preen_test/static
...
ENV DJANGO_SETTINGS_MODULE=preen_test.settings.deploy
...
ENV UWSGI_WSGI_FILE=preen_test/wsgi.py
